...
(0, _lodash.assign)(Client.prototype, {
  ...
  getPoolSettings(poolConfig) {
    ...
    ].filter((timeout) => timeout !== undefined); // acquire connection timeout can be set on config or config.pool
      ...
      create: () => {
        return this.acquireRawConnection().tap((connection) => {
          ...
          if (poolConfig.afterCreate) {
            return _bluebird.default.promisify(poolConfig.afterCreate)(
              connection
            );
          }
        });
  ...
  acquireConnection() {
    ...
    return _bluebird.default
      ...
      .catch(_tarn.TimeoutError, () => {
        throw new _bluebird.default.TimeoutError(
