...
const trigger = {
  ...
  createAutoIncrementTrigger: function createAutoIncrementTrigger(
    ...
    const triggerName = formatter.wrap(
      utils.generateCombinedName('autoinc_trg', tableNameRaw)
    );
    const sequenceName = formatter.wrap(
      utils.generateCombinedName('seq', tableNameRaw)
    );
    const tableName = formatter.wrap(tableNameRaw);
    return (
      `DECLARE ` +
  ...
  renameTableAndAutoIncrementTrigger: function renameTableAndAutoIncrementTrigger(
    ...
    const toTriggerName = formatter.wrap(
      utils.generateCombinedName('autoinc_trg', toRaw)
    );
    const toSequenceName = formatter.wrap(
      utils.generateCombinedName('seq', toRaw)
    );
    const tableName = formatter.wrap(tableNameRaw);
    const to = formatter.wrap(toRaw);
    return (
